...
try {
    switch ($action) {
        ...
        case 'git_diff':
            ...
            // Verifica se o arquivo é rastreado (para evitar erro em untracked files)
            // Diff para staged e unstaged
            // Se for untracked, não tem diff, podemos retornar "Arquivo Novo" ou rodar diff em /dev/null
